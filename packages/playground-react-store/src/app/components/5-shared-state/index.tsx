    ...
    <div>
      ...
      <div className="markdown-body max-w px-4 pt-12">
        <p className="font-normal text-md my-1 pb-8 pl-4 pr-8">
          Normal React hooks are tightly coupled to view component instances. This means that state shared between the
          components is not readily available inside each component's hook.
          <br />
          <br />
          Reactive store hooks, however, are coupled to a store instance and can be reused with 1..n view components.
          Each component can now have access to the hook's store, its services, and its shared state.
          <br />
          <br />
          Store state can even be preserved between component routing...
        </p>
        <CodeBox
          fileName="counter.hook.tsx"
          style="width: 767px; height: 340px;"
          src="https://carbon.now.sh/embed/l3ht00ncUC0MhhkGgYHz"
        />
        <p className="font-normal text-md my-1 pt-4 pb-4 pl-4 pr-8"></p>
        <CodeBox
          fileName="counter.store.ts"
          style="width: 767px; height: 340px;"
          src="https://carbon.now.sh/embed/rmqpRqs0Ap5FfbzsH2RE"
        />
      </div>
    </div>
  );
